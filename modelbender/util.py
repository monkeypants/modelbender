...
code that I didn't want to keep looking at in the main modelender.py script
"""
import os
import os.path
import re
            ...
            for resource_name in os.listdir(domain_path):
                ...
                if os.path.isfile(resource_path):
                    if DOT_PATTERN.match(resource_name):
                        #print("    TODO: do the DOT thing to {}".format(resource_path))
                        cmds = (DOT_PATTERN,)
                        execute_commands(cmds, resource_name, domain_path)
                    elif DIAG_PATTERN.match(resource_name):
                        #print("    TODO: do one of the DIAG things to {}".format(resource_path))
                        if BLOCK_DIAG_PATTERN.match(resource_name):
                            ...
                            msg = mst_tmpl.format(resource_path)
                            raise Exception(msg)
                        execute_commands(cmds, resource_name, domain_path)
